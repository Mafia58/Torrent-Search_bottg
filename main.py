...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("Developer: @akalankanime", url="https://t.me/akalankanime")]
                ]
    ...
    try:
        await message.reply_text(
            text="Hello, I am Torrent Search Bot!\n"
                 "I can search Torrent & Magnet Links from Inline.\n\n"
                 "Made by @akalankanime",
